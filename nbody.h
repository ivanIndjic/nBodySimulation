...
#define DISPLAY_SIZE       750     /* pixel size of display window */
#define SCALE               0.02    /* sets the magnification at the origin */
                                    /* smaller #'s zoom in */
#define XMIN (-1/SCALE)
#define XMAX (1/SCALE)
#define YMIN (-1/SCALE)
...
#define GRAV_CONSTANT       9.81    /* proportionality constant of
